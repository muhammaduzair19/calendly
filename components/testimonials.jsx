                    ...
                    <CarouselItem key={index} className="md:basis-1/2 lg:basis-1/3">
                        <Card className="h-full">
                            <CardContent className="flex flex-col justify-between h-full p-6">
                                <p className="text-gray-600 mb-4">&quot; {testimonail.content} &quot;</p>
                                <div className="flex items-center mt-4">
                                    <Avatar className="h-12 w-12 mr-4">
                                        <AvatarImage src={testimonail.image} alt={testimonail.name} />
                                        <AvatarFallback>
                                            {testimonail.name
                                                .split(" ")
                                                .map((n) => n[0])
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">{testimonail.role}</p>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
